...
impl KvRouterConfig {
    ...
    fn new(
        ...
        remote_g2_min_planned_blocks: u32,
        remote_g2_score_tax_blocks: u32,
        remote_g2_score_cost_per_block: f64,
        remote_g2_score_cap_blocks: Option<u32>,
