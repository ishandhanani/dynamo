...
|---|---|---|
| `DYN_EPP_MODE=standalone` | Yes | Runs the embedded selection service without the Dynamo runtime. `DYN_EPP_MODE=dynamo` (runtime-backed EPP) is deprecated and logs a warning at startup; it remains available for this release. |
