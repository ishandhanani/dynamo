...
Dynamo 提供内置指标、分布式追踪和日志，用于监控推理部署。请参阅 [Observability Guide](https://github.com/ai-dynamo/dynamo/blob/3b7675444c56e7f93bd191539d5ee4a430622729/docs/fern/pages/kubernetes/installation/observability.md) 了解设置详情。
